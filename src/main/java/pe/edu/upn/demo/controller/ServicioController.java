...
public class ServicioController {
	...
	private String info(@PathVariable("codigo") int codigo, Model model , Model model1, Cita cita) {
	...
	@PostMapping("/save")
	private String save(@ModelAttribute("cita") @Valid Cita cita, BindingResult result, SessionStatus status , Model model) {
